...
main = mapM_ (\(sink, p) -> sink =<< runSolver defaultLog ( ic3 vs init t p )) [ (inv, not (pc .=. cnst 2) .|. not (n .<. i))
                                                                               , (cex, not (pc .=. cnst 2) .|. i .<. n)
                                                                               , (cex, not (pc .=. cnst 2) .|. not (cnst 0 .<. i))
                                                                               , (inv, not (pc .=. cnst 2) .|. not (cnst 5 .<. i))
                                                                               , (cex, not (pc .=. cnst 2) .|. i .<. cnst 5)
                                                                               , (inv, not (pc .=. cnst 2) .|. not (cnst 10 .<. i)) ]
